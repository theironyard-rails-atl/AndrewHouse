...
describe Player do
  me = Player.new
  it "should start the game with $100" do
    assert_equal me.total_cash, 100
  end
end
...
describe Game do
  ...
  it "starts the game with 2 cards" do
    assert_equal @game.dealt_cards.hand.count, 2
  end

  it "should add one card one a hit" do
    @game.hit
    assert_equal @game.dealt_cards.hand.count, 3
  end
